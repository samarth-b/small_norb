...
wget --directory-prefix=./small_norb_root https://cs.nyu.edu/~ylclab/data/norb-v1.0-small/smallnorb-5x46789x9x18x6x2x96x96-testing-dat.mat.gz
wget --directory-prefix=./small_norb_root https://cs.nyu.edu/~ylclab/data/norb-v1.0-small/smallnorb-5x46789x9x18x6x2x96x96-testing-cat.mat.gz
wget --directory-prefix=./small_norb_root https://cs.nyu.edu/~ylclab/data/norb-v1.0-small/smallnorb-5x46789x9x18x6x2x96x96-testing-info.mat.gz
